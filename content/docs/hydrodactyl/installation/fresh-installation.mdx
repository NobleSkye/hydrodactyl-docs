...
description: A comprehensive guide for setting up Hydrodactyl using Docker
---

This comprehensive guide walks you through setting up Hydrodactyl using Docker, from scratch to a fully functional system.
...
1. Download and configure the docker-compose file [(template)](https://raw.githubusercontent.com/blueprintframework/hydrodactyl/main/docker-compose.example.yml).

   - Modify all placeholder variables under `x-common`
   - Adjust exposed ports if needed (add 443 if you want to use HTTPS)

1. Create a new folder (e.g. hydrodactyl-panel) on your server in a safe location, and move or upload your edited compose file into it. Rename the file to docker-compose.yml.
...
1. Debug issues
1. Switch back to Hydrodactyl image when resolved

## Additional Resources

- [Docker Documentation](https://docs.docker.com/)
- [Hydrodactyl GitHub](https://github.com/blueprintframework/hydrodactyl)
- [Pterodactyl Documentation](https://pterodactyl.io/)
- [Hydrodactyl Discord](https://https://discord.gg/mnTJVSSaKp)
