...
description: A comprehensive guide for setting up Hydrodactyl using Dokploy
---

This guide walks you through setting up Hydrodactyl using Dokploy, from initial deployment to a fully functional system.
...
<Callout type="info">
  Need help? Join our [Hydrodactyl Discord](https://https://discord.gg/mnTJVSSaKp) or
  open a discussion on
  [GitHub](https://github.com/blueprintframework/hydrodactyl/discussions).
</Callout>
...
- Select Template
- Search For **_Hydrodactyl_**
- Select Create
- Choose what server to install it to
- Select Confirm

3. **Configuring Hydrodactyl**

- The only thing you as a user need to change is the domain.
    1. Select the domains tab under the hydrodactyl panel service
