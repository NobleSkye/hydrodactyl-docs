...
description: Guide for updating your native Hydrodactyl installation and resolving common issues
---
...
![Hydrodactyl Latest Release](https://img.shields.io/github/v/release/blueprintframework/hydrodactyl?style=for-the-badge)
...
1. Navigate to your Hydrodactyl installation directory:

   ```bash
   cd /path/to/your/hydrodactyl
   ```
