...
description: Guide for migrating from native Pterodactyl installation to native Hydrodactyl installation
---

## Migrating from Pterodactyl (Native → Native)

<Callout type='error'>
Once you switch to Hydrodactyl, switching back to Pterodactyl is not supported and may cause errors as Hydrodactyl modifies the Pterodactyl Database Schema. Provided below is how you can make a backup of your Panel Database if you need to switch back. It is also recommended that you make a backup of the Pterodactyl folder aswell if anything goes wrong during migration. (Replace ``panel`` with the database name you use)
...
1. Download and extract the latest Hydrodactyl release:
...
🎉 **Boom! Your panel is now migrated to Hydrodactyl!**
