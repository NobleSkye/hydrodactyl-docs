...
- Switched to official `blueprintframework` Docker images (from `blueprintframework/images` repo)

### Changed
- Email templates updated to match Hydrodactyl theme
...
### Changed
- Changed itzg java 25 image for custom built image at [blueprintframework/images](https://github.com/blueprintframework/images/pkgs/container/images/621911322?tag=java_25)
