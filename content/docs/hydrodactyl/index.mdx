...
- **More accessible**: Pyro believes that gaming should be easily available for everyone. Hydrodactyl builds with the latest Web accessibility guidelines in mind. Hydrodactyl is entirely keyboard-navigable, even context menus, and screen-readers are easily compatible.
...
Hydrodactyl™ Copyright 2025 Pyro Inc. and contributors.
